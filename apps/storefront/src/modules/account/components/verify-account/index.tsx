...
const VerifyAccount = () => {
  ...
  return (
    ...
    >
      <h1 className="text-large-semi uppercase">{t("email_verification")}</h1>
      ...
      {state === "success" && (
        <>
          ...
          <LocalizedClientLink href="/account">
            <Button variant="primary">{t("go_to_sign_in")}</Button>
          </LocalizedClientLink>
        </>
      )}
      ...
      {state === "error" && (
        <>
          ...
          <LocalizedClientLink href="/account">
            <Button variant="secondary">{t("go_to_sign_in")}</Button>
          </LocalizedClientLink>
        </>
      )}
    </div>
